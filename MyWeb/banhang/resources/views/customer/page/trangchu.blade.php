        ...
        <div class="col-md-12">
            <div class="card-deck">
                <div class="card Adv_Card">
                    ...
                    <div class="card-body">
                        <div class="card-title text-center"> 
                            <a href="luckycake/customer/loaisanpham/{{1}}"> 
                ...
                <div class="card Adv_Card">
                    ...
                    <div class="card-body">
                        <div class="card-title text-center"> 
                            <a href="luckycake/customer/loaisanpham/{{2}}">
                ...
                <div class="card Adv_Card">
                    ...
                    <div class="card-body">
                        <div class="card-title text-center"> 
                            <a href="luckycake/customer/loaisanpham/{{3}}">
                                <h5 class="text-uppercase"> Hamburger </h5>
                            </a>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-row mt-3">
                                    ...
                                    <button class="btn btn-outline-primary"> 
                                        <a href="luckycake/customer/chitietsanpham/{{$index->id}}" class="link text-dark"> Chi tiết >> </a> 
                                    </button>
                                </div>
